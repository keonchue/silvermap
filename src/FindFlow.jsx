      ...
      {showRouteUI && (
        <>
          ...
          <div style={{
            ...
            overflow: 'hidden',
            transform: navMode ? 'translateY(100%)' : 'translateY(0)',
          ...
          {navMode && (
            <div
              ...
              onTouchEnd={e => {
                ...
                if (dragStartY.current - e.changedTouches[0].clientY > 30) setNavMode(false)
            ...
            >
              ...
              <span style={{
                flex: 1, fontWeight: 900, fontSize: 'var(--fs-base)',
                color: 'var(--success)',
